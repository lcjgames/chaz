    ...
    Map {
        ...
        rival_positions: Positions {
            values: vec![
                ...
                Vec3::new(1404.171, -72.1462, 1.0),
                Vec3::new(1404.183, -72.16744, 1.0),
                Vec3::new(1404.183, -72.16744, 1.0),
                Vec3::new(1404.183, -72.16744, 1.0),
                Vec3::new(1404.173, -72.14964, 1.0),
                Vec3::new(1404.162, -72.13122, 1.0),
                Vec3::new(1404.163, -72.13284, 1.0),
                Vec3::new(1404.181, -72.1638, 1.0),
                Vec3::new(1404.182, -72.16562, 1.0),
                Vec3::new(1404.174, -72.15138, 1.0),
                Vec3::new(1404.18, -72.162, 1.0),
                Vec3::new(1404.185, -72.17113, 1.0),
                Vec3::new(1404.154, -72.11858, 1.0),
                Vec3::new(1404.162, -72.13122, 1.0),
                Vec3::new(1404.173, -72.14964, 1.0),
                Vec3::new(1404.18, -72.162, 1.0),
                Vec3::new(1404.154, -72.11858, 1.0),
                Vec3::new(1404.165, -72.13612, 1.0),
                Vec3::new(1404.163, -72.13284, 1.0),
                Vec3::new(1404.179, -72.1602, 1.0),
